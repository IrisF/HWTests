...
int out = 0b00000000;
String user = "x";
String timeShown = "0,5 Sek";
int counter = 0;
int pos1[] = {num2,num7,num5,num5,num7,num8,num6,num1,num4,num5};
int pos2[] = {num6,num8,num3,num9,num5,num3,num7,num8,num4,num8};
int pos3[] = {num9,num8,num5,num5,num5,num5,num8,num7,num9,num2};
int pos4[] = {num4,num3,num4,num4,num4,num2,num4,num8,num1,num9};
int pos5[] = {num1,num8,num3,num9,num1,num2,num1,num7,num5,num8};
int pos6[] = {num3,num1,num6,num1,num8,num6,num7,num7,num5,num2};
